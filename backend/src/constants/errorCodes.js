const ERROR_CODES = {
  ...
  SALE_NOT_EDITABLE: 'Only today\'s sales can be edited',
  ...
  VALIDATION_CHIEF_REQUIRED: 'Chief is required',
  ...
  VALIDATION_DISH_INVALID: 'Invalid dish id',
  VALIDATION_INVALID_WEIGHT_TYPE: 'Invalid weight type',
  VALIDATION_INVALID_PAYMENT: 'Invalid payment method',
  VALIDATION_TIP_NOT_ALLOWED_FOR_CASH: 'Tips are not allowed for cash payments',
  ...
  CHIEF_EXPENSE_NOT_FOUND: 'Chief expense not found',
  RECEIPT_NOT_FOUND: 'Receipt not found',
  VALIDATION_INVALID_EXPENSE_CATEGORY: 'Invalid expense category',
  VALIDATION_INVALID_CHIEF_EXPENSE_CATEGORY: 'Invalid chief expense category',
  ...
  TIP_ALREADY_PAID: 'Tips already paid for this period',
  NO_TIPS_TO_PAY: 'No tips to pay for this period',
